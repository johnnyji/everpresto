...
_mongoose2['default'].connect('mongodb://localhost/' + _config2['default'].development.databaseName, function (err) {
  if (err) {
    throw err;
  }
});
...
// routes
router.use('/', _routesRootRoute2['default']);
router.use('/timesheets', _routesTimesheetsRoute2['default']);
