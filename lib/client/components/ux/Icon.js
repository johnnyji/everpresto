    ...
    switch (this.props.icon) {
      case 'help':
        return _react2['default'].createElement(
          'g',
          null,
          _react2['default'].createElement('path', { d: 'M12 2c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92c-.72.73-1.17 1.33-1.17 2.83h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z' })
        );
      case 'chevron-right':
        return _react2['default'].createElement(
          'g',
      ...
      case 'add-circle':
        return _react2['default'].createElement(
          'g',
          null,
          _react2['default'].createElement('path', { d: 'M12 2c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm5 11h-4v4h-2v-4h-4v-2h4v-4h2v4h4v2z' })
        );
      case 'add':
        return _react2['default'].createElement(
          'g',
