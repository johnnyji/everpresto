...
var GroupNameInput = (function (_ReactTemplate) {
  ...
  function GroupNameInput(props) {
    ...
    this._bindFunctions('_incrementActiveFormPhaseIndex', '_onUserInput');
  }

  _createClass(GroupNameInput, [{
    key: '_onUserInput',
    value: function _onUserInput(e) {
      _actionsNewGroupActions2['default'].handleNameChange(e.target.value);
    }
  }, {
    key: '_incrementActiveFormPhaseIndex',
    value: function _incrementActiveFormPhaseIndex() {
      _actionsNewGroupActions2['default'].incrementActiveFormPhaseIndex();
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'button',
          { onClick: this._incrementActiveFormPhaseIndex },
          'Next ',
