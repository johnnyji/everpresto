...
var _articlesArticlesList = require('./articles/ArticlesList');

var _articlesArticlesList2 = _interopRequireDefault(_articlesArticlesList);
...
var GroupsHandler = (function (_ReactTemplate) {
  ...
  function GroupsHandler(props) {
    ...
    this._bindFunctions('_updateState', '_changeActiveTabIndex', '_searchArticles', '_toggleNewArticleModal');
  }
  ...
  _createClass(GroupsHandler, [{
    ...
    key: '_searchArticles',
    value: function _searchArticles(searchTerms) {
      console.log('search hit: ', searchTerms);
    }
  }, {
    key: '_toggleNewArticleModal',
    value: function _toggleNewArticleModal(e) {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_sharedSearchBar2['default'], { onInputChange: this._searchArticles })
        ),
        _react2['default'].createElement(_articlesArticlesList2['default'], { articles: this.props.articles })
      );
    }
  }]);
