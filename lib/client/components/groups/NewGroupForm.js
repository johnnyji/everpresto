...
var NewGroupForm = (function (_ReactTemplate) {
  ...
  _createClass(NewGroupForm, [{
    ...
    value: function render() {
      var p = this.props;
      var s = this.state;
      var phases = [_react2['default'].createElement(_GroupNameInput2['default'], { error: s.errors.name }), _react2['default'].createElement(_GroupAddMembersInput2['default'], { contacts: p.currentUser.contacts, error: s.errors.members })];
