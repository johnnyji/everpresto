...
var _fakerLocaleEn = require('faker/locale/en');

var _fakerLocaleEn2 = _interopRequireDefault(_fakerLocaleEn);
  ...
  _createClass(ContactInviteForm, [{
    ...
    value: function _addNewField() {
      ...
      fields.push(_react2['default'].createElement(_ContactInviteField2['default'], {
        ...
        placeholder: {
          firstName: _fakerLocaleEn2['default'].name.firstName(),
          lastName: _fakerLocaleEn2['default'].name.lastName(),
          email: _fakerLocaleEn2['default'].internet.email()
        }
      }));
