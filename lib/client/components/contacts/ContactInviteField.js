    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'td',
          null,
          _react2['default'].createElement('input', { type: 'text', placeholder: p.placeholder.firstName, onChange: this._handleFirstNameChange })
        ),
        _react2['default'].createElement(
          'td',
          null,
          _react2['default'].createElement('input', { type: 'text', placeholder: p.placeholder.lastName, onChange: this._handleLastNameChange })
        ),
        _react2['default'].createElement(
          'td',
          null,
          _react2['default'].createElement('input', { type: 'text', placeholder: p.placeholder.email, onChange: this._handleEmailChange }),
          _react2['default'].createElement(
            'span',
...
ContactInviteField.propTypes = {
  ...
  placeholder: _react2['default'].PropTypes.object.isRequired
};
