...
var ChatWindow = (function (_ReactTemplate) {
  _inherits(ChatWindow, _ReactTemplate);

  function ChatWindow() {
    _classCallCheck(this, ChatWindow);

    _get(Object.getPrototypeOf(ChatWindow.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(ChatWindow, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement('div', { className: 'messages-section' }),
