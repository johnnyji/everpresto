...
var _InvoiceSelector = require('./InvoiceSelector');

var _InvoiceSelector2 = _interopRequireDefault(_InvoiceSelector);
...
var NewProjectForm = (function (_ReactTemplate) {
  ...
  function NewProjectForm(props) {
    ...
    this._bindFunctions('_updateState', '_exitForm', '_setTitle', '_setDescription', '_setBudget');
  }
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_InvoiceSelector2['default'], {
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_sharedInputFieldLabel2['default'], {
            labelName: 'Assignees',
            shrinkLabel: false
          }),
          _react2['default'].createElement(
