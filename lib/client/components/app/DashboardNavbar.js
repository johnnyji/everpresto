    ...
    value: function render() {
      ...
      var links = this.props.navLinks.map(function (link, i) {
        return _react2['default'].createElement(
          'li',
          { className: 'dashboard-navbar-content-item', key: i },
          _react2['default'].createElement(
            _reactRouter.Link,
            {
              activeClassName: 'dashboard-navbar-content-item-tab-active',
              className: 'dashboard-navbar-content-item-tab',
              to: link.path },
            link.name
          )
        );
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'ul',
          { className: 'dashboard-navbar-content' },
          links
        )
      );
    }
