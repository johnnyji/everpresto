...
var EmployerDashboard = (function (_ReactTemplate) {
  ...
  _createClass(EmployerDashboard, [{
    ...
    value: function render() {
      var weekBeingViewed = _utilsDateHelper2['default'].formatWeekDurationFromDate(Date.now());
      return _react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement(_dateDateNavbar2['default'], { weekBeingViewed: weekBeingViewed })
      );
    }
  }]);
