...
var _employerProjectsNewProjectForm = require('.././employer/projects/NewProjectForm');

var _employerProjectsNewProjectForm2 = _interopRequireDefault(_employerProjectsNewProjectForm);
  ...
  _createClass(AppHandler, [{
    ...
    value: function render() {
      ...
      if (s.modal.newProject) {
        var modalContent = _react2['default'].createElement(_employerProjectsNewProjectForm2['default'], null);
