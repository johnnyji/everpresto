...
var _groupsArticlesNewArticleForm = require('.././groups/articles/NewArticleForm');

var _groupsArticlesNewArticleForm2 = _interopRequireDefault(_groupsArticlesNewArticleForm);
  ...
  _createClass(AppHandler, [{
    ...
    value: function render() {
      ...
      if (s.modal.newArticle) {
        var modalContent = _react2['default'].createElement(_groupsArticlesNewArticleForm2['default'], { contacts: s.currentUser.contacts });
        modal = _react2['default'].createElement(_sharedFullScreenModal2['default'], { modalContent: modalContent });
      }
