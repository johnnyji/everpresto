...
var SearchBar = (function (_React$Component) {
  ...
  _createClass(SearchBar, [{
    key: '_toggleFocusState',
    value: function _toggleFocusState() {
    ...
    value: function render() {
      var searchIconClass = this.state.focus ? 'search-focus' : '';

      return _react2['default'].createElement(
        'div',
        { className: 'search-bar-wrapper' },
        _react2['default'].createElement(_Icon2['default'], { icon: 'search', iconClass: searchIconClass }),
