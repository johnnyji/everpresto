...
var FileUploader = (function (_ReactTemplate) {
  ...
  _createClass(FileUploader, [{
    ...
    value: function _handleFileUpload() {
      this.props.onUploadFile();
    }
  }, {
    key: '_removeUploadedFile',
    value: function _removeUploadedFile() {
        ...
        var filePreviewIcons = _lodash2['default'].map(p.files, function (file, i) {
          return _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(Icon, { icon: 'close' })
            )
          );
        });
...
FileUploader.propTypes = {
  onUploadFile: _react2['default'].PropTypes.func.isRequired,
