...
var ReactTemplate = (function (_React$Component) {
  _inherits(ReactTemplate, _React$Component);

  function ReactTemplate() {
    _classCallCheck(this, ReactTemplate);

    _get(Object.getPrototypeOf(ReactTemplate.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ReactTemplate, [{
    key: '_bindFunctions',
    ...
    key: '_protectComponent',
    value: function _protectComponent() {
      // redirects the user to default route if unauthorized
      var isDefaultRoute = this.context.router.getCurrentPathname() === '/';
