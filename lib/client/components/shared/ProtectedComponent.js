  ...
  var ProtectedComponent = (function (_React$Component) {
    ...
    _createClass(ProtectedComponent, [{
      ...
      value: function render() {
        ...
        if (s.currentUser) {
          return _react2['default'].createElement(ComponentToBeRendered, _extends({}, this.props, { currentUser: s.currentUser }));
        } else {
          return _react2['default'].createElement(_Spinner2['default'], { fullScreen: true });
        }
      }
    }]);
