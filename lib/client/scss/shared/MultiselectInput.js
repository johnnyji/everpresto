...
var MultiselectInput = (function (_React$Component) {
  _inherits(MultiselectInput, _React$Component);

  function MultiselectInput() {
    _classCallCheck(this, MultiselectInput);

    _get(Object.getPrototypeOf(MultiselectInput.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(MultiselectInput, [{
    key: 'toggleShrinkLabel',
    value: function toggleShrinkLabel() {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement(InputFieldLabel, {
          labelName: p.label,
        ...
        _react2['default'].createElement(_reactWidgets.Multiselect, {
          ...
          caseSensitive: false,
          filter: 'contains',
          onChange: this._updateAssignees,
          data: employees
        })
      );
    }
