...
var GroupContent = (function (_ReactTemplate) {
  _inherits(GroupContent, _ReactTemplate);

  function GroupContent() {
    _classCallCheck(this, GroupContent);

    _get(Object.getPrototypeOf(GroupContent.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(GroupContent, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        'div',
        { className: 'group-content-wrapper' },
        ...
        _react2['default'].createElement(NotesList, { notes: this.props.notes })
      );
    }
  }]);
