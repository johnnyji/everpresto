...
var ProjectStore = Reflux.createStore({
  ...
  projectsLoaded: function projectsLoaded() {
    return this.state.projectsLoaded;
  },
  onChangeActiveTabIndex: function onChangeActiveTabIndex(index) {
    this.state.activeTabIndex = index;
    this.trigger(this.state);
  },
  onLoadProjectsCompleted: function onLoadProjectsCompleted(response) {
